...
//	public final static Paint obstacleColor = new Color(192,255,192);
	// gradient obstacles!  Try it!  Slower but fun!
	 ...
	 public static double UpperVisibility = 16*DIAMETER;  //visibility of the upper door  
	 public static double lowerVisibility=40*DIAMETER;   //visibility of the  lower door
