...
public class CrowdWithUI extends GUIState{
	...
	ContinuousPortrayal2D boxPortrayal = new ContinuousPortrayal2D();
	...
	public void setupPortrayals()
	{
		...
		boxPortrayal.setField(Crowd.boxEnvironment);
		
		obstaclesPortrayal.setField(Crowd.obstaclesEnvironment);

		buddiesPortrayal.setField( new SpatialNetwork2D( Crowd.boxEnvironment, Crowd.marking ) );
	...
	public void init(Controller c)
	{
		...
		display.attach( boxPortrayal, "boundry" );
		display.attach( obstaclesPortrayal, "Obstacles" );
		display.attach( buddiesPortrayal, "Edges" );
	}
