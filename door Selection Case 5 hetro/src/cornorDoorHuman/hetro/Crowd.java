...
public class Crowd  extends SimState {
	...
	//where to cut for the door in upper region
	public static final double lwDoorLeft = 170;
	public static final double lwDoorRight =178;
	...
	public void start()
	{
		...
		//show doorArea (It is showing constant door area but actual is vary based on human's diameter)
		int diam = (int)(DoorArea.UpperVisibility*1.5);
		DoorArea darea1 = new DoorArea(diam);
		doorEnvironment.setObjectLocation(darea1, new Double2D(doorMid,yMinB));
		//lower door
		diam =  (int)(DoorArea.lowerVisibility*1.5);
